...
class GetIssueReqModal {
  ...
  factory GetIssueReqModal.fromJson(Map<String, dynamic> json) {
    return GetIssueReqModal(
      id: json['id'],
...
//       revokedPoint: json['revokedPoint'] != null ? AtPoint.fromJson(json['revokedPoint']) : null,
//       issuedPoint: AtPoint.fromJson(json['issuedPoint']),
//     );
//   }
//
//   Map<String, dynamic> toJson() {
...
//       otp: json['otp'],
//       otpTime: json['otpTime'],
//       issuedCycle: json['issuedCycle'] != null ? Cycle.fromJson(json['issuedCycle']) : null,
//       point: json['point'] != null ? AtPoint.fromJson(json['point']) : null,
//     );
//   }
//
//   Map<String, dynamic> toJson() {
...
//       'otp': otp,
//       'otpTime': otpTime,
//       'issuedCycle': issuedCycle?.toJson(),
//       'point': point?.toJson(),
//     };
//   }
// }
