class LoginModal {
  ...
  LoginModal.fromJson(Map<String, dynamic> json) {
    authenticate = json['authenticate'] != null ? new Authenticate.fromJson(json['authenticate']) : null;
...
class Authenticate {
  ...
  Authenticate({this.authorities, this.details, this.authenticated, this.principal, this.credentials, this.name});
